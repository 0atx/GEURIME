...
public class AuthService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        var userProfile = AuthAttributes.extract(registrationId, attributes);
    ...
    private void saveOrUpdate(UserProfile userProfile) {
        ...
        var user = userRepository.findByEmailAndProvider(userProfile.getEmail(), userProfile.getProvider()) //Optional<User>
